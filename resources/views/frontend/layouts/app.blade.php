...
<!-- Mirrored from template.hasthemes.com/autima/autima/index-5.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 07 Nov 2021 12:04:44 GMT -->
<head>
    <meta charset="utf-8">
...
<body>
                    ...
                    <div class="Offcanvas_menu_wrapper">
                        ...
                        <div class="top_right text-right">
                            <ul>
                                ...
                                <li class="language"><a href="#"><img src="{{ asset('assets/frontend/img/logo/language.png') }}" alt="">en-gb<i class="ion-ios-arrow-down"></i></a>
                                    <ul class="dropdown_language">
                                        <li><a href="#"><img src="{{ asset('assets/frontend/img/logo/language.png') }}" alt=""> English</a></li>
                                        <li><a href="#"><img src="{{ asset('assets/frontend/img/logo/language2.png') }}" alt=""> Germany</a></li>
                                    </ul>
    ...
    <!--slider area start-->
    <section class="slider_section mb-5 mt-4">
        <div class="container">
            <div class="row">
                <div class="col-lg-9 col-12">
                    <div class="slider_area slider_three slider_new5 owl-carousel">
                        <div class="single_slider d-flex align-items-center" data-bgimg="{{ asset('assets/frontend/img/slider/slider7.jpg') }}">
                        ...
                        <div class="single_slider d-flex align-items-center" data-bgimg="{{ asset('assets/frontend/img/slider/slider8.jpg') }}">
                            <div class="slider_content">
                                <h2>Brade Wheels</h2>
                        ...
                        <div class="single_slider d-flex align-items-center" data-bgimg="{{ asset('assets/frontend/img/slider/slider9.jpg') }}">
                            <div class="slider_content">
                                <h2>Top Quality</h2>
                ...
                <div class="col-lg-3 col-12">
                    <div class="row mx-n2 mt-lg-n3">
                        <div class="col-lg-12 col-md-4 col-sm-6 col-12">
                            <div class="sidebar_banner m-0">
                                <div class="banner_thumb">
                                    <a href="shop.html"><img src="{{ asset('assets/frontend/img/bg/slider-banner-1.jpg') }}" alt=""></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-4 col-sm-6 col-12 mt-3">
                            <div class="sidebar_banner m-0">
                                <div class="banner_thumb">
                                    <a href="shop.html"><img src="{{ asset('assets/frontend/img/bg/slider-banner-2.jpg') }}" alt=""></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-4 col-sm-6 col-12 mt-3">
                            <div class="sidebar_banner m-0">
                                <div class="banner_thumb">
                                    <a href="shop.html"><img src="{{ asset('assets/frontend/img/bg/slider-banner-3.jpg') }}" alt=""></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="product_carousel product_column5 owl-carousel">
                        <div class="single_product">
                            ...
                            <div class="product_thumb">
                                <a class="primary_img" href="product-details.html"><img src="{{ asset('assets/frontend/img/product/product19.jpg') }}" alt=""></a>
                                <a class="secondary_img" href="product-details.html"><img src="{{ asset('assets/frontend/img/product/product11.jpg') }}" alt=""></a>
                        ...
                        <div class="single_product">
                            ...
                            <div class="product_thumb">
                                <a class="primary_img" href="product-details.html"><img src="{{ asset('assets/frontend/img/product/product12.jpg') }}" alt=""></a>
                                <a class="secondary_img" href="product-details.html"><img src="{{ asset('assets/frontend/img/product/product13.jpg') }}" alt=""></a>
                                <div class="label_product">
                        ...
                        <div class="single_product">
                            ...
                            <div class="product_thumb">
                                <a class="primary_img" href="product-details.html"><img src="{{ asset('assets/frontend/img/product/product15.jpg') }}" alt=""></a>
                                <a class="secondary_img" href="product-details.html"><img src="{{ asset('assets/frontend/img/product/product14.jpg') }}" alt=""></a>
                                <div class="label_product">
                                    <span class="label_sale">-57%</span>
                                </div>
                        ...
                        <div class="single_product">
                            ...
                            <div class="product_thumb">
                                <a class="primary_img" href="product-details.html"><img src="{{ asset('assets/frontend/img/product/product16.jpg') }}" alt=""></a>
                                <a class="secondary_img" href="product-details.html"><img src="{{ asset('assets/frontend/img/product/product17.jpg') }}" alt=""></a>
                                <div class="label_product">
                                    <span class="label_sale">-57%</span>
                                </div>
                        ...
                        <div class="single_product">
                            ...
                            <div class="product_thumb">
                                <a class="primary_img" href="product-details.html"><img src="{{ asset('assets/frontend/img/product/product18.jpg') }}" alt=""></a>
                                <a class="secondary_img" href="product-details.html"><img src="{{ asset('assets/frontend/img/product/product1.jpg') }}" alt=""></a>
                                <div class="label_product">
                        ...
                        <div class="single_product">
                            ...
                            <div class="product_thumb">
                                <a class="primary_img" href="product-details.html"><img src="{{ asset('assets/frontend/img/product/product2.jpg') }}" alt=""></a>
                                <a class="secondary_img" href="product-details.html"><img src="{{ asset('assets/frontend/img/product/product3.jpg') }}" alt=""></a>
                                <div class="label_product">
                                    <span class="label_sale">-57%</span>
                                </div>
                        ...
                        <div class="single_product">
                            ...
                            <div class="product_thumb">
                                <a class="primary_img" href="product-details.html"><img src="{{ asset('assets/frontend/img/product/product4.jpg') }}" alt=""></a>
                                <a class="secondary_img" href="product-details.html"><img src="{{ asset('assets/frontend/img/product/product5.jpg') }}" alt=""></a>
                                <div class="label_product">
                                    <span class="label_sale">-57%</span>
                                </div>
                ...
                <div class="col-12">
                    <div class="banner_container">
                        <div class="single_banner">
                            <div class="banner_thumb">
                                <a href="#"><img src="{{ asset('assets/frontend/img/bg/banner3.jpg') }}" alt=""></a>
                        ...
                        <div class="single_banner">
                            <div class="banner_thumb">
                                <a href="#"><img src="{{ asset('assets/frontend/img/bg/banner4.jpg') }}" alt=""></a>
                                <div class="banner_text">
                                    <h3>All - New</h3>
                ...
                <div class="col-12">
                    <div class="product_tab_button tab_button2">
                        <ul class="nav" role="tablist" id="nav-tab">
                            <li>
                                <a class="active" data-toggle="tab" href="#featured" role="tab" aria-controls="featured" aria-selected="true"><span>New</span> Products</a>
                            </li>
                            <li>
                ...
                <div class="tab-pane fade show active" id="featured" role="tabpanel">
                    <div class="new_product_container">
                        <div class="sample_product">
                            ...
                            <div class="product_thumb">
                                <a href="#"><img src="{{ asset('assets/frontend/img/product/product19.jpg') }}" alt=""></a>
                            </div>
                            <div class="product_content">
                                <div class="product_ratings">
                                    <ul>
                        ...
                        <div class="product_carousel product_bg  product_column2 owl-carousel">
                            <div class="small_product">
                                ...
                                <div class="single_product">
                                    ...
                                    <div class="product_thumb">
                                        <a class="primary_img" href="product-details.html"><img src="{{ asset('assets/frontend/img/product/product5.jpg') }}" alt=""></a>
                                    </div>
                                </div>
                            </div>
                            <div class="small_product">
                                <div class="single_product">
                                    ...
                                    <div class="product_thumb">
                                        <a class="primary_img" href="product-details.html"><img src="{{ asset('assets/frontend/img/product/product10.jpg') }}" alt=""></a>
                                    </div>
                                </div>
                                <div class="single_product">
                                    <div class="product_content">
                                    ...
                                    <div class="product_thumb">
                                        <a class="primary_img" href="product-details.html"><img src="{{ asset('assets/frontend/img/product/product11.jpg') }}" alt=""></a>
                                    </div>
                                </div>
                                <div class="single_product">
                                    <div class="product_content">
                                    ...
                                    <div class="product_thumb">
                                        <a class="primary_img" href="product-details.html"><img src="{{ asset('assets/frontend/img/product/product13.jpg') }}" alt=""></a>
                                    </div>
                                </div>
                            </div>
                            <div class="small_product">
                                <div class="single_product">
                                    ...
                                    <div class="product_thumb">
                                        <a class="primary_img" href="product-details.html"><img src="{{ asset('assets/frontend/img/product/product7.jpg') }}" alt=""></a>
                                    </div>
                                </div>
                                <div class="single_product">
                                    <div class="product_content">
                                    ...
                                    <div class="product_thumb">
                                        <a class="primary_img" href="product-details.html"><img src="{{ asset('assets/frontend/img/product/product14.jpg') }}" alt=""></a>
                                    </div>
                                </div>
                                <div class="single_product">
                                    <div class="product_content">
                            ...
                            <div class="small_product">
                                ...
                                <div class="single_product">
                                    ...
                                    <div class="product_thumb">
                                        <a class="primary_img" href="product-details.html"><img src="{{ asset('assets/frontend/img/product/product17.jpg') }}" alt=""></a>
                                    </div>
                                </div>
                                <div class="single_product">
                                    <div class="product_content">
                ...
                <div class="tab-pane fade" id="view" role="tabpanel">
                    <div class="new_product_container">
                        <div class="sample_product">
                            ...
                            <div class="product_thumb">
                                <a href="#"><img src="{{ asset('assets/frontend/img/product/product15.jpg') }}" alt=""></a>
                            </div>
                            <div class="product_content">
                                <div class="product_ratings">
                                    <ul>
                        ...
                        <div class="product_carousel product_bg  product_column2 owl-carousel">
                            <div class="small_product">
                                ...
                                <div class="single_product">
                                    ...
                                    <div class="product_thumb">
                                        <a class="primary_img" href="product-details.html"><img src="{{ asset('assets/frontend/img/product/product6.jpg') }}" alt=""></a>
                                    </div>
                                </div>
                                <div class="single_product">
                                    <div class="product_content">
                            ...
                            <div class="small_product">
                                <div class="single_product">
                                    ...
                                    <div class="product_thumb">
                                        <a class="primary_img" href="product-details.html"><img src="{{ asset('assets/frontend/img/product/product8.jpg') }}" alt=""></a>
                                    </div>
                                </div>
                                <div class="single_product">
                                    <div class="product_content">
                                    ...
                                    <div class="product_thumb">
                                        <a class="primary_img" href="product-details.html"><img src="{{ asset('assets/frontend/img/product/product9.jpg') }}" alt=""></a>
                                    </div>
                                </div>
                                <div class="single_product">
                                    <div class="product_content">
                    ...
                    <div class="featured_container">
                        <div class="featured_carousel featured_column3 owl-carousel">
                            <div class="single_items">
                                <div class="single_featured">
                                    <div class="featured_thumb">
                                        <a href="#"><img src="{{ asset('assets/frontend/img/featured/featured.jpg') }}" alt=""></a>
                                    </div>
                                ...
                                <div class="single_featured">
                                    <div class="featured_thumb">
                                        <a href="#"><img src="{{ asset('assets/frontend/img/featured/featured1.jpg') }}" alt=""></a>
                                    </div>
                                    <div class="featured_content">
                            ...
                            <div class="single_items">
                                <div class="single_featured">
                                    <div class="featured_thumb">
                                        <a href="#"><img src="{{ asset('assets/frontend/img/featured/featured2.jpg') }}" alt=""></a>
                                    </div>
                                    <div class="featured_content">
                                ...
                                <div class="single_featured">
                                    <div class="featured_thumb">
                                        <a href="#"><img src="{{ asset('assets/frontend/img/featured/featured3.jpg') }}" alt=""></a>
                                    </div>
                                    <div class="featured_content">
                            ...
                            <div class="single_items">
                                <div class="single_featured">
                                    <div class="featured_thumb">
                                        <a href="#"><img src="{{ asset('assets/frontend/img/featured/featured4.jpg') }}" alt=""></a>
                                    </div>
                                    <div class="featured_content">
                                ...
                                <div class="single_featured">
                                    <div class="featured_thumb">
                                        <a href="#"><img src="{{ asset('assets/frontend/img/featured/featured5.jpg') }}" alt=""></a>
                                    </div>
                                    <div class="featured_content">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="single_banner banner_fullwidth">
                        <div class="banner_thumb">
                            <a href="#"><img src="{{ asset('assets/frontend/img/bg/banner5.jpg') }}" alt=""></a>
                            <div class="banner_text">
                    ...
                    <div class="custom_product">
                        ...
                        <div class="small_product_items small_product_active">
                            <div class="single_product_items">
                                <div class="product_thumb">
                                    <a href="product-details.html"><img src="{{ asset('assets/frontend/img/product/product1.jpg') }}" alt=""></a>
                                </div>
                                <div class="product_content">
                                    <div class="product_name">
                                        <h3><a href="product-details.html">Variable with soldout product for title</a></h3>
                            ...
                            <div class="single_product_items">
                                <div class="product_thumb">
                                    <a href="product-details.html"><img src="{{ asset('assets/frontend/img/product/product2.jpg') }}" alt=""></a>
                                </div>
                                <div class="product_content">
                                    <div class="product_name">
                            ...
                            <div class="single_product_items">
                                <div class="product_thumb">
                                    <a href="product-details.html"><img src="{{ asset('assets/frontend/img/product/product3.jpg') }}" alt=""></a>
                                </div>
                                <div class="product_content">
                                    <div class="product_name">
                            ...
                            <div class="single_product_items">
                                <div class="product_thumb">
                                    <a href="product-details.html"><img src="{{ asset('assets/frontend/img/product/product4.jpg') }}" alt=""></a>
                                </div>
                                <div class="product_content">
                                    <div class="product_name">
                                        <h3><a href="product-details.html">1. New and sale new badge product </a></h3>
                            ...
                            <div class="single_product_items">
                                <div class="product_thumb">
                                    <a href="product-details.html"><img src="{{ asset('assets/frontend/img/product/product5.jpg') }}" alt=""></a>
                                </div>
                                <div class="product_content">
                                    <div class="product_name">
                                        <h3><a href="product-details.html">Accusantium dolorem Security Camera</a></h3>
                            ...
                            <div class="single_product_items">
                                <div class="product_thumb">
                                    <a href="product-details.html"><img src="{{ asset('assets/frontend/img/product/product6.jpg') }}" alt=""></a>
                                </div>
                                <div class="product_content">
                                    <div class="product_name">
                                        <h3><a href="product-details.html">1. New and sale new badge product </a></h3>
                ...
                <div class="col-lg-4 col-md-12">
                    ...
                    <div class="custom_product">
                        ...
                        <div class="small_product_items small_product_active">
                            <div class="single_product_items">
                                <div class="product_thumb">
                                    <a href="product-details.html"><img src="{{ asset('assets/frontend/img/product/product8.jpg') }}" alt=""></a>
                                </div>
                                <div class="product_content">
                                    <div class="product_name">
                                        <h3><a href="product-details.html">1. New and sale new badge product </a></h3>
                            ...
                            <div class="single_product_items">
                                <div class="product_thumb">
                                    <a href="product-details.html"><img src="{{ asset('assets/frontend/img/product/product9.jpg') }}" alt=""></a>
                                </div>
                                <div class="product_content">
                                    <div class="product_name">
                                        <h3><a href="product-details.html">Accusantium dolorem Security Camera</a></h3>
                            ...
                            <div class="single_product_items">
                                <div class="product_thumb">
                                    <a href="product-details.html"><img src="{{ asset('assets/frontend/img/product/product10.jpg') }}" alt=""></a>
                                </div>
                                <div class="product_content">
                                    <div class="product_name">
                                        <h3><a href="product-details.html">1. New and sale new badge product </a></h3>
                            ...
                            <div class="single_product_items">
                                <div class="product_thumb">
                                    <a href="product-details.html"><img src="{{ asset('assets/frontend/img/product/product11.jpg') }}" alt=""></a>
                                </div>
                                <div class="product_content">
                                    <div class="product_name">
                                        <h3><a href="product-details.html">Accusantium dolorem Security Camera</a></h3>
                            ...
                            <div class="single_product_items">
                                <div class="product_thumb">
                                    <a href="product-details.html"><img src="{{ asset('assets/frontend/img/product/product12.jpg') }}" alt=""></a>
                                </div>
                                <div class="product_content">
                                    <div class="product_name">
                                        <h3><a href="product-details.html">1. New and sale new badge product </a></h3>
                ...
                <div class="col-lg-4 col-md-12">
                    ...
                    <div class="custom_product">
                        ...
                        <div class="small_product_items small_product_active">
                            ...
                            <div class="single_product_items">
                                <div class="product_thumb">
                                    <a href="product-details.html"><img src="{{ asset('assets/frontend/img/product/product13.jpg') }}" alt=""></a>
                                </div>
                                <div class="product_content">
                                    <div class="product_name">
                                        <h3><a href="product-details.html">1. New and sale new badge product </a></h3>
                            ...
                            <div class="single_product_items">
                                <div class="product_thumb">
                                    <a href="product-details.html"><img src="{{ asset('assets/frontend/img/product/product14.jpg') }}" alt=""></a>
                                </div>
                                <div class="product_content">
                                    <div class="product_name">
                                        <h3><a href="product-details.html">Accusantium dolorem Security Camera</a></h3>
                            ...
                            <div class="single_product_items">
                                <div class="product_thumb">
                                    <a href="product-details.html"><img src="{{ asset('assets/frontend/img/product/product15.jpg') }}" alt=""></a>
                                </div>
                                <div class="product_content">
                                    <div class="product_name">
                                        <h3><a href="product-details.html">1. New and sale new badge product </a></h3>
                ...
                <div class="col-12">
                    <div class="brand_container owl-carousel">
                        <div class="single_brand">
                            <a href="#"><img src="{{ asset('assets/frontend/img/brand/brand.png') }}" alt=""></a>
                        </div>
                        <div class="single_brand">
                            <a href="#"><img src="{{ asset('assets/frontend/img/brand/brand1.png') }}" alt=""></a>
                        </div>
                        <div class="single_brand">
                            <a href="#"><img src="{{ asset('assets/frontend/img/brand/brand2.png') }}" alt=""></a>
                        </div>
                        <div class="single_brand">
                            <a href="#"><img src="{{ asset('assets/frontend/img/brand/brand3.png') }}" alt=""></a>
                        </div>
                        <div class="single_brand">
                            <a href="#"><img src="{{ asset('assets/frontend/img/brand/brand4.png') }}" alt=""></a>
                        </div>
                        <div class="single_brand">
                            <a href="#"><img src="{{ asset('assets/frontend/img/brand/brand2.png') }}" alt=""></a>
                        </div>
